<tbody id="table_tbody">
    ...
    ?>
                ...
                <tr>
                    ...
                    <td width="5%"><?php echo $value['pm_entry_no']; ?></td>
                    <td width="8%"><?php echo date('d-m-Y', strtotime($value['pm_entry_date'])); ?></td>
                    <td width="5%"><?php echo $value['pm_bill_no']; ?></td>
                    <td width="8%"><?php echo date('d-m-Y', strtotime($value['pm_bill_date'])); ?></td>
                    <td width="10%"><?php echo $value['supplier_name']; ?></td>
                    <td width="8%"><?php echo $value['pm_total_mtr']; ?></td>
                    <td width="8%"><?php echo $value['pm_total_amt']; ?></td>
                    <td width="3%">
                        <a 
                            type="button" 
                            class="btn btn-sm btn-primary" 
                            target="_blank" 
                            href="<?php echo base_url($menu.'/'.$sub_menu.'?action=barcode&clause=bm.bm_pm_id&id='.$id) ?>"
