...
class MYPDF extends TCPDF 
{
    ...
    { 
        ...
        $tbl_header = '<table cellpadding="3" style="border-top: 1px solid #000; border-left: 1px solid #000;border-right: 1px solid #000;">  
                        <tr>
                            ...
                            <td width="50%" style="text-align:right;"><b>PURCHASE FABRIC</b></td>
                        </tr>
                    </table>
                    ...
                    <table  border="1" cellpadding="3">
                        <tr>
                            ...
                            <th style="width:15%;text-align:center;"><b>FABRIC</b></th>
                            ...
                            <th style="width:8%;text-align:center;"><b>ROLL</b></th>
    ...
    public function Footer() 
    {
        ...
        $gst_amt = $master_pdf[0]['pm_sgst_amt'] + $master_pdf[0]['pm_cgst_amt'] + $master_pdf[0]['pm_igst_amt'];
        ...
        $tbl_footer .='<table width="100%"  border="0" style="border:1px solid #000;" cellpadding="4" >
            <tr style="font-size:12px;">
                ...
                <th style="width:8%;text-align:center"><b>'.$master_pdf[0]['total_mtr'].'</b></th>
        ...
        <tr>
            ...
            $tbl_footer .='
                    <tr>
                        ...
                        <td width="60%"style="font-size:10px;" align="right">'.$master_pdf[0]['pm_sub_amt'].'</td>
                    </tr>';

            if($master_pdf[0]['pm_disc_amt'] >0){
                $tbl_footer .='<tr>
                    <td width="40%" style="font-size:10px;" align="left">DISC AMT </td>
                    <td width="60%"style="font-size:10px;" align="right">&nbsp;&nbsp;'.$master_pdf[0]['pm_disc_amt'].'</td>
                </tr>';
            }
            ...
            $tbl_footer .='
                ...
                <tr>
                    ...
                    <td width="60%"style="font-size:10px;" align="right">'.$master_pdf[0]['pm_extra_amt'].'</td>
                </tr>
                <tr>
                    <td width="40%" style="font-size:10px;" align="left">SGST AMT </td>
                    <td width="60%"style="font-size:10px;" align="right">'.$master_pdf[0]['pm_sgst_amt'].'</td>
                </tr>
                <tr>
                    <td width="40%" style="font-size:10px;" align="left">CGST AMT </td>
                    <td width="60%"style="font-size:10px;" align="right">'.$master_pdf[0]['pm_cgst_amt'].'</td>
                </tr>';
            $tbl_footer .= '<tr>
                    <td width="40%" style="font-size:10px;" align="left">IGST AMT </td>
                    <td width="60%"style="font-size:10px;" align="right">'.$master_pdf[0]['pm_igst_amt'].'</td>
                </tr>';
            
            if($master_pdf[0]['pm_bill_disc_amt'] >0){
                $tbl_footer .='<tr>
                    <td width="40%" style="font-size:10px;" align="left">Bill DISC</td>
                    <td width="60%"style="font-size:10px;" align="right">&nbsp;&nbsp;'.$master_pdf[0]['pm_bill_disc_amt'].'</td>
                </tr>';
            }
...
$body .= '<table cellpadding="2" >';
            foreach($trans_data as $key => $value) :
                ...
                $body .= '<tr style="font-size:11px;">
                            ...
                            <td style="width:15%;text-align:center;border-bottom-color:#ccc;">'.$value['fabric_name'].'</td>
                            <td style="width:15%;text-align:center;border-bottom-color:#ccc;"><b>'.$value['design_name'].'</b></td>
                            <td style="width:15%;text-align:center;border-bottom-color:#ccc;">'.$value['category_name'].'</td>
                            ...
                            <td style="width:8%;text-align:center;border-bottom-color:#ccc;">'.$value['total_mtr'].'</td>
