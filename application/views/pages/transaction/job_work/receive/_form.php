        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item text-uppercase">
                    <a href="<?php echo base_url($menu.'/'.$sub_menu.'?action=receive'); ?>">
...
<section class="container-fluid my-3">
    <form class="form-horizontal" id="_form">
        <?php $this->load->view('pages/'.$menu.'/'.$sub_menu.'/receive/_body'); ?>
    </form>
</section>
<?php $this->load->view('templates/footer'); ?>
<?php $this->load->view('pages/'.$menu.'/'.$sub_menu.'/receive/_footer'); ?>
</body>
</html>