<tbody id="table_tbody">
    ...
    ?>
                ...
                <tr>
                    ...
                    <td width="5%"><?php echo $value['prm_entry_no']; ?></td>
                    <td width="8%"><?php echo date('d-m-Y', strtotime($value['prm_entry_date'])); ?></td>
                    <td width="10%"><?php echo $value['supplier_name']; ?></td>
                    <td width="8%"><?php echo $value['prm_total_mtr']; ?></td>
                    <td width="8%"><?php echo $value['prm_total_amt']; ?></td>
