<?php $this->mypdf_class->tcpdf();
                                ...
                                <td>
                                    <table border="0" cellpadding="5">
                                        <tr>
                                            ...
                                            <td width="60%" align="center" style="font-size:12px;"><b>SUPPLIER LEDGER</b></td>
	...
	$pdf->SetTitle('SUPPLIER LEDGER PDF');
	$pdf->SetSubject('SUPPLIER LEDGER PDF');
    ...
    if(!empty($data)):
        foreach ($data as $key => $value): 
            $body .= ' <tr>
							...
							<td width="30%">'.$value['supplier_name'].'</td>
							<td width="10%" >'.$value['purchase_amt'].'</td>
	...
	ob_end_clean();
	$pdf->Output('SUPPLIER LEDGER PDF.pdf', 'I');
	//============================================================+
	// END OF FILE
	//============================================================+
