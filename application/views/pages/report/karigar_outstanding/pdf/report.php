<?php $this->mypdf_class->tcpdf();
		...
		public function Header(){ 
			...
			$header .= '<table border="1" cellpadding="3">
                                ...
                                <td>
                                    <table border="0" cellpadding="5">
                                        <tr>
                                            ...
                                            <td width="60%" align="center" style="font-size:12px;"><b>KARIGAR OUTSTANDING</b></td>
						...
						<table border="1" cellpadding="3" style="font-size:8px;">
							<tr>
								<th width="3%">#</th>
								<th width="37%">KARIGAR</th>
								<th width="15%">OPENING AMT</th>
								<th width="15%">HISAB AMT</th>
	...
	$pdf->SetTitle('karigar outstanding');
	$pdf->SetSubject('karigar outstanding');
	...
	$body .= '<table border="1" cellpadding="5">
		<tr style="background-color:#0000">
			...
			<th width="15%">'.$totals['hisab_amt'].'</th>
    ...
    if(!empty($data)):
        foreach ($data as $key => $value):
            $body .= ' <tr>
							<td width="3%">'.($key + 1).'</td>
							<td width="37%">'.$value['karigar_name'].'</td>
							<td width="15%">'.$value['opening_amt'].'</td>
							<td width="15%">'.$value['hisab_amt'].'</td>
	...
	ob_end_clean();
	$pdf->Output('karigar outstanding.pdf', 'I');
	//============================================================+
	// END OF FILE
	//============================================================+
