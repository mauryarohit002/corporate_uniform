<?php $this->mypdf_class->tcpdf();
                                ...
                                <td>
                                    <table border="0" cellpadding="5">
                                        <tr>
                                            ...
                                            <td width="60%" align="center" style="font-size:12px;"><b>CUSTOMER OUTSTANDING</b></td>
	...
	$pdf->SetTitle('customer outstanding');
	$pdf->SetSubject('customer outstanding');
	...
	$body .= '<table border="1" cellpadding="5">
		<tr style="background-color:#0000">
			...
			<th width="15%">'.$totals['sales_amt'].'</th>
			<th width="15%">'.$totals['receipt_amt'].'</th>
    ...
    if(!empty($data)):
        foreach ($data as $key => $value):
            $body .= ' <tr>
							<td width="3%">'.($key + 1).'</td>
							<td width="37%">'.$value['customer_name'].'</td>
							<td width="15%">'.$value['opening_amt'].'</td>
							<td width="15%">'.$value['sales_amt'].'</td>
							<td width="15%">'.$value['receipt_amt'].'</td>
	...
	ob_end_clean();
	$pdf->Output('customer outstanding.pdf', 'I');
	//============================================================+
	// END OF FILE
	//============================================================+
