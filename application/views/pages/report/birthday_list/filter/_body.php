        ...
        <div class="d-flex col-12 col-sm-12 col-md-6 col-lg-6 mt-3">
            <div class="floating-label">
                <input 
                    ...
                    id="_birth_date_from" 
                    name="_birth_date_from" 
                    value="<?php echo isset($filters['_birth_date_from']) ? $filters['_birth_date_from'] : date('Y-m-d') ?>" 
                    placeholder=" " 
                    autocomplete="off" 
                />   
                <label class="text-uppercase">birth date <small class="font-weight-bold">from</small></label>
            </div>
            <div class="floating-label">
                <input 
                    type="date" 
                    ...
                    id="_birth_date_to" 
                    name="_birth_date_to" 
                    value="<?php echo isset($filters['_birth_date_to']) ? $filters['_birth_date_to'] : date('Y-m-d') ?>" 
                    placeholder=" " 
                    autocomplete="off" 
                />   
                <label class="text-uppercase">birth date <small class="font-weight-bold">to</small></label>
            </div>
        </div>
    </div>
</div>