<tbody id="table_tbody" class="font-weight-bold" style="font-size: 0.7rem;">
    ...
    ?>
                <tr>
                    ...
                    <td width="3%"><?php echo $value['module_name']; ?></td>
                    <td width="4%"><?php echo $value['entry_no']; ?></td>
                    <td width="5%"><?php echo $value['entry_date1']; ?></td>
                    <td width="10%"><?php echo $value['billing_name']; ?></td>
                    <td width="8%"><?php echo $value['billing_mobile']; ?></td>
                    ...
                    <td width="5%"><?php echo $value['bill_disc_amt']; ?></td>
                    <td width="5%"><?php echo $value['total_amt']; ?></td>
                    <td width="6%"><?php echo $value['advance_amt']; ?></td>
                    <td width="6%"><?php echo $value['balance_amt']; ?></td>
                </tr>
    <?php 
            endforeach;
        else: 
