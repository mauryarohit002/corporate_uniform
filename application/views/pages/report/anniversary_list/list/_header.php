<thead>
    ...
    <th width="5%">
        <div class="d-flex">
            <div class="d-flex flex-column">
                <input type="radio" class="d-none" id="customer_anniversary_date-fa-caret-up" name="sorting" onclick="sorting_data('-customer_anniversary_date')">
                <label for="customer_anniversary_date-fa-caret-up" style="margin:0px;">
                    <i class="fa fa-fw fa-caret-up text-danger" id="-customer_anniversary_date"></i>
                </label>

                <span class="text-uppercase">anniversary date</span>
                <input type="radio" class="d-none" id="customer_anniversary_date-fa-caret-down" name="sorting" onclick="sorting_data('customer_anniversary_date')">
                <label for="customer_anniversary_date-fa-caret-down" style="margin:0px;">
                    <i class="fa fa-fw fa-caret-down text-danger" id="customer_anniversary_date"></i>
                </label>
            </div>
        </div>
    </th>
