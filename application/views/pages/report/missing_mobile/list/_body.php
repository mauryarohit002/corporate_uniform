<tbody id="table_tbody" class="font-weight-bold" style="font-size: 0.7rem;">
    ...
    ?>
                <tr>
                    ...
                    <td width="10%"><?php echo $value['contact_person']; ?></td>
                    <td width="5%"><?php echo $value['customer_mobile']; ?></td>
                    <td width="5%"><?php echo $value['customer_phone']; ?></td>
                    <td width="8%" class="text-lowercase"><?php echo $value['customer_email']; ?></td>
