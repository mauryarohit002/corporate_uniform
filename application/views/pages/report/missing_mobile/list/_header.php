<thead>
    ...
    <th width="10%">
        <div class="d-flex">
            <div class="d-flex flex-column">
                <input type="radio" class="d-none" id="contact_person-fa-caret-up" name="sorting" onclick="sorting_data('-contact_person')">
                <label for="contact_person-fa-caret-up" style="margin:0px;">
                    <i class="fa fa-fw fa-caret-up text-danger" id="-contact_person"></i>
                </label>

                <span class="text-uppercase">contact person</span>
                <input type="radio" class="d-none" id="contact_person-fa-caret-down" name="sorting" onclick="sorting_data('contact_person')">
                <label for="contact_person-fa-caret-down" style="margin:0px;">
                    <i class="fa fa-fw fa-caret-down text-danger" id="contact_person"></i>
                </label>
            </div>
        </div>
    </th>
    ...
    <th width="5%">
        <div class="d-flex">
            <div class="d-flex flex-column">
                <input type="radio" class="d-none" id="customer_phone-fa-caret-up" name="sorting" onclick="sorting_data('-customer_phone')">
                <label for="customer_phone-fa-caret-up" style="margin:0px;">
                    <i class="fa fa-fw fa-caret-up text-danger" id="-customer_phone"></i>
                </label>

                <span class="text-uppercase">phone</span>
                <input type="radio" class="d-none" id="customer_phone-fa-caret-down" name="sorting" onclick="sorting_data('customer_phone')">
                <label for="customer_phone-fa-caret-down" style="margin:0px;">
                    <i class="fa fa-fw fa-caret-down text-danger" id="customer_phone"></i>
                </label>
            </div>
        </div>
    </th>
