<div class="row">
    <div class="d-flex flex-wrap justify-content-center floating-form">
        ...
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 floating-label mt-3">
            <?php if(isset($filters['_code'])): ?><p class="text-uppercase">code</p><?php endif; ?>
            <select class="form-control floating-select" id="_code" name="_code">
                <?php if(isset($filters['_code']) && !empty($filters['_code'])): ?>
                    <option value="<?php echo $filters['_code']['value']; ?>" selected>
                        <?php echo $filters['_code']['text']; ?> 
                    </option>
                <?php endif; ?>
            </select>
        </div>
