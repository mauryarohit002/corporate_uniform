...
class missing_mobile_model extends my_model{
    public function __construct(){ parent::__construct('report', 'missing_mobile'); }
    public function get_record(){
        ...
        if(isset($_REQUEST['_contact_person']) && !empty($_REQUEST['_contact_person'])){
            $subsql .=" AND customer.customer_contact_person = '".$_REQUEST['_contact_person']."'";
            $record['filter']['_contact_person']['value'] = $_REQUEST['_contact_person'];
            $record['filter']['_contact_person']['text']  = $_REQUEST['_contact_person'];
        }
        $query="SELECT 
