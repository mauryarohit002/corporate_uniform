...
const render = (data, page) => {
  ...
  let content = data.map((data, index) => {
    ...
    return `<tr>
                    ...
                    <td width="5%">${contact_person}</td>
                    <td width="5%">${birth_date}</td>
                    <td width="10%" class="text-lowercase">${customer_email}</td>
...
const filters_arr = ["_customer_name", "_birth_date_from", "_birth_date_to"];
